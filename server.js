...
app.post("/create-checkout-session", async (req, res) => {
    try {
        const { orderId, items = [], totalPrice, customerName, customerEmail, deliveryFee = 0, pizzaDiscount = 0 } = req.body || {};

        // Compute subtotal from items (for fallback and metadata)
        ...
        // Prefer a single line item using the FINAL TOTAL
        let line_items;
